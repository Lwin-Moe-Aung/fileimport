<?php
	...
	if(!isset($_POST["import"]) && isset($_GET['ts'])) {	
		 $dbobj = new DBSource();
		 ...
		 $cols = json_decode($result[0], true);
		 $id = $result[1];	
	...
	*/
	if(isset($_POST["import"]) && isset($_POST["import"]) == "Import" && isset($_GET['ts'])) {	
